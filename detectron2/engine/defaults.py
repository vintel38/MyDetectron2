...
class CustomTrainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        mapper = DatasetMapper(cfg, is_train=True, augmentations=[T.Resize((800, 800)), T.RandomBrightness(0.8, 1.8), T.RandomContrast(0.6, 1.3), T.RandomFlip(prob=0.4, horizontal=True, vertical=True), T.MinIoURandomCrop()])
